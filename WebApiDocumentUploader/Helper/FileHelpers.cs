...
namespace WebApiDocumentUploader.Helper
{
    ...
    public static class FileHelpers
    {
            ...
            try
            {
                using (var memoryStream = new MemoryStream())
                {
                    ...
                    if (!IsValidFileExtensionAndSignature(
                        formFile.FileName, memoryStream, permittedExtensions, true))
                    {
                        modelState.AddModelError(formFile.Name,
        ...
        private static bool IsValidFileExtensionAndSignature(string fileName, Stream data, string[] permittedExtensions, bool skipCheck = false)
        {
            if (skipCheck)
                return true;
